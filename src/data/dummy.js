...
import { SiAppsignal, SiAtom, SiApachenetbeanside, SiAzuredataexplorer, SiHomebridge } from "react-icons/si";
...
import clxrity from './clxrity.png';
...
export const EditorData = () => (
  <div>
    <h3>
      This website was built with <a href='https://reactjs.org/' target='_blank'>React</a>, <a href='https://www.syncfusion.com/' target='_blank'>Syncfusion</a>, and <a href='https://tailwindcss.com/' target='_blank'>TailwindCSS</a>.
      <br />
      <br />
      This editor is a sample of one of many features that are accessible through Syncfusion.
      <br />
      <br />
      You can edit this text and format it however you wish. This is <i>just</i> <u>an</u> <b>example</b>.
      <br />
      <br />
      <img src={clxrity} width='25px' height='25px'/>
      Website created by <b><a href='https://clxrity.xyz' target='_blank'>clxrity</a></b>.
    </h3>
  </div>
);
...
export const coolData = [
  {
    ...
    text: 'Connect',
    amount: '90%',
    description: 'We all desire connections'
  },
  {
    icon: <SiAtom />,
    title: 'Atomic',
    ...
    text: 'Versatile',
    amount: '67%',
    description: "It's important to retain skills in many fields"
  },
  {
    ...
    text: 'Equal',
    amount: '50%',
    description: "Treat everyone with equality"
  },
  {
    ...
    text: 'Explore',
    amount: '23.9%',
    description: 'Exploration outside of your comfort zone'
  }
];
